...
export interface TypedElectronApi<
  ...
  SYNC_API extends
    BackendSyncApiType<SYNC_CHANNELS> = BackendSyncApiType<SYNC_CHANNELS>,
  ASYNC_API extends
    BackendAsyncApiType<ASYNC_CHANNELS> = BackendAsyncApiType<ASYNC_CHANNELS>,
> {
  /**
  ...
  invoke<T extends SYNC_CHANNELS>(
    channel: T,
    ...args: SYNC_API[T]['props'] extends void ? [] : [SYNC_API[T]['props']]
